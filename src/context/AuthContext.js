      ...
      if (firebaseUser) {
        ...
        try {
          ...
          if (snap.exists()) {
            ...
            // First sign-in for this uid — no users/{uid} doc exists yet.
            if (firebaseUser.isAnonymous) {
              // Anonymous bootstrap — name / mobile come later from User Setup.
              ...
              // Email / Google login — assign admin to the known admin email, field to everyone else.
